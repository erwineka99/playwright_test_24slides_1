...
The pipeline runs on push and pull request to `main` or `master`.
...
6. Upload Playwright report as an artifact.

## Clean Code Notes

- Tests use Playwright auto-waiting and assertions.
- No hard-coded sleep or timeout-based wait is used.
- Selectors and page actions are centralized in the Page Object class.
- Assertions validate real user-visible behavior.
- Test data is simple and does not submit fake fraud reports.
...
The automation suite validates the main Kredibel UI flows using a maintainable Playwright setup with Page Object Model, parallel execution, HTML reporting, and CI support.
